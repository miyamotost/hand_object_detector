...
if __name__ == '__main__':
  ...
  for index, item in df.iterrows():
    ...
    pred_file = '{}_{}_{}.pkl'.format(item['video_id'], item['start_frame'], item['stop_frame'])
    pred_p_path = '{}/{}'.format(args.pred_dir, item['participant_id'])
    pred_path = '{}/{}'.format(pred_p_path, pred_file)

    if not os.path.exists(pred_p_path):
        os.makedirs(pred_p_path)
